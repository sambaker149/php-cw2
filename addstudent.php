...
if (isset($_SESSION['id'])) 
{
   ...
   // If form has been submitted
    if (isset($_POST['submit'])) 
    {
      ...
      // Checks if form is empty and displays return message
        ...
        $data['content'] = "<p>Please fill in ALL required fields to continue!</p><br>" .
    ...
    else 
    {
     ...
     // SQL query inserting new student record  
